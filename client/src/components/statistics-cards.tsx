...
export function StatisticsCards({ selectedChannels }) {
  // In a real application, you would fetch this data based on the selected channels
  const stats = {
    activeSubscribers: 100000,
    totalSpent: 50000,
    uploadFrequency: 3,
  }
